...
LATTICE handles source pointers, rights policy, context closure, budgets,
frontiers, receipts, and local materialization. Reports should identify whether
an issue can bypass policy, omit required closure, corrupt a receipt, expose
source content, or produce a misleading success result.
